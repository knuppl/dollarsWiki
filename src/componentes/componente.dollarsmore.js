...
export default function ComponenteDollarsMore({
  descricao,
  personagens,
  curiosidades,
  imagens,
      ...
      <View>
        ...
        {curiosidades.map((item, index) => (
           <View key={`curiosidade_${index}`}>
            ...
            <Text style={estilos.descricaoSinopse}>{item.curiosidades}</Text>
            </View>
            <Text style={estilos.detalhes}>{item.nome}</Text>
            </View>
        ))}
        ...
        <View style={estilos.padding}>
        <Text style={estilos.detalhes}>{descricao.legado}</Text>
        </View>
